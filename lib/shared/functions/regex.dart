...
bool validatePureString(String string) {
  String pattern = r"^[a-z,A-Z, ]+$";
  return RegExp(pattern).hasMatch(string);
}

/// checks if the string is pure ie. only digits from 0-9
bool validateStringIsNumber(String string) {
